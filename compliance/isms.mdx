...
- Automatic channel fallback: Internet → SMS A2P → Voice → LoRa → Satellite → Edge
...
The following items are under active progression as part of Wede's enterprise readiness programme:

- DPO designation — in progress
- External penetration test — scheduled with CREST/CHECK accredited provider
- ISO 27001 formal certification — audit planned
- HIPAA BAA — available on request before first US healthcare deployment
