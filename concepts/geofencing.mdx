...
The geofence penalty adds `0.20` to the score. Since lower scores are better, teams outside the event zone are ranked lower but not excluded — cross-zone escalation is always possible.
