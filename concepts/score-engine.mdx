...
The score engine algorithm — including proximity scoring, geofencing via point-in-polygon, and offline dispatch queue with cryptographic integrity — is covered by patent application INPI 120488 (Portugal), pending.