...
<Note>
  LoRa, satellite, and edge processing are on the roadmap. Voice delivery is built and in pilot rollout with our voice provider. Current production channels are REST Full, REST Compressed, and Structured Protocols (SMS).
</Note>
...
| **sms\_only** | Internet unavailable | Structured Protocols (Voice in pilot rollout) |
