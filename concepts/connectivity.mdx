...
| **sms_only** | Internet unavailable | Structured protocols (SMS) active; voice fallback is in pilot rollout |
| **offline** | All external channels down | Events queue locally with guaranteed sync on reconnection; LoRa, satellite and edge delivery are on our roadmap |
