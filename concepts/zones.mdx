...
A zone is a geographic operational area, defined and managed by your tenant within your pre-agreed geographic coverage. Each zone has its own connectivity state, channel configuration, and incident tracking.
...
The number of zones you can create is limited by your plan.
