...
If internet is unavailable, Wede automatically routes via SMS or voice — the payload is fragmented, transmitted, and reassembled at the destination without any changes to your code.
...
|-----------------|-----------------|
| ICT risk management | Multi-channel fallback — SMS, voice, LoRa automatic |
